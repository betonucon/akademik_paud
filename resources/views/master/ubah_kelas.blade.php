            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Kelas</label>
                    <input class="form-control item" onkeypress="return hanyaAngka(event)"  type="text" name="kelas" value="{{$data['kelas']}}">
                  </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control item"   placeholder="Nama Kelas" type="text" name="name" value="{{$data['name']}}">
                  </div>
