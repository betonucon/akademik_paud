            ...
            <div class="box-body" >
                <div class="margin" style="padding:1%;">
                    ...
                    <div class="alert alert-dismissible" style="color:#615757;background:#fafafd;margin-top:10px">
                        ...
                        <h4><i class="icon fa fa-info"></i>Rekapan Pembayaran</h4>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="background: none;padding:2px">
                                <b>SPP &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;:</b> {{uang(total_keuangan_spp($bulan,$tahun))}}</a>
                            </li>
                            <li class="list-group-item" style="background: none;padding:2px">
                                <b>Daftar Ulang :</b> {{uang(total_keuangan_daftar($bulan,$tahun))}}</a>
                            </li>
                            <li class="list-group-item" style="background: none;padding:2px">
                                <b>Donasi &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;:</b> {{uang(total_keuangan_donasi($bulan,$tahun))}}</a>
                            </li>
                            <li class="list-group-item" style="background: none;padding:2px">
                                <b>Total &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;:</b> {{uang(total_keuangan_daftar($bulan,$tahun)+total_keuangan_spp($bulan,$tahun)+total_keuangan_donasi($bulan,$tahun))}}</a>
                            </li>
                        </ul>
                    </div>
