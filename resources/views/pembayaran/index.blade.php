                ...
                @if($aksi=='new')
                    <div class="row">
                        ...
                        <form method="post" id="mydatatambah" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6" style="border: solid 1px #c1aaaa;min-height: 250px;">
                                <div class="form-group" style="">
                ...
                @if($aksi=='edit')
                    <div class="row">
                        ...
                        <form method="post" id="mydataubah" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="">Pembayaran</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#cari_data').click(function(){
                ...
                window.open("{{url('rekapan/'.$link.'/')}}/"+siswa_id+"/"+tahun_ajaran_cari+"/"+kelas_cari, '_blank');
                $('#modalcek').modal('hide');        
            });
