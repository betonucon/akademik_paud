                ...
                <div class="margin" style="padding:1%;">
                    <div class="btn-group" style="width:100%;">
                        ...
                        <select class="form-control" id="kelas_id" style="display:inline;width:20%;margin-left:2px;float:left">
                            <option value="all" @if($kelas=='all') selected @endif>Pilih Level---</option>
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                var table = $('#tabeldata').DataTable({
                    ...
                    "ajax": {
                        "type": "GET",
                        "url": "{{url('/api_rekapan_daftar_ulang/'.$tahun.'/'.$kelas)}}",
                        "timeout": 120000,
            ...
            $('#cari').click(function(){
                ...
                window.location.assign("{{url('rekapan_daftar_ulang')}}?tahun="+tahun_ajaran_cari+"&kelas="+kelas_cari);
                        
            });
            $('#cetak').click(function(){
                var tahun_ajaran_cari=$('#tahun').val();
                var kelas_cari=$('#kelas_id').val();
                window.open("{{url('pdf_rekapan_daftar_ulang')}}/"+tahun_ajaran_cari+"/"+kelas_cari,"_blank");
